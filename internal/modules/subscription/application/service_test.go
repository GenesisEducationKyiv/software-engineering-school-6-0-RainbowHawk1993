...
func TestSubscribeSuccess(t *testing.T) {
	...
	mailer := &fakeMailer{}
	builder := &fakeBuilder{}
	service := NewService(store, github, mailer, nil, builder, "http://localhost:8080")
...
func TestConfirmRejectsInvalidToken(t *testing.T) {
	...
	service := NewService(&fakeStore{}, &fakeGitHub{}, &fakeMailer{}, nil, &fakeBuilder{}, "http://localhost:8080")
